<?php session_start(); ?>
<?php $con = new mysqli("localhost","muthu","muthumuthu","budget_calculator");$tablename = $_SESSION["username"]."-expectations"; ?>
<?php
                ...
                <?php
                    ...
                    if($total_left == $total){
                        ...
                        if($total_left/$total*100>=75 and $total_left/$total*100<=99.999){
                            echo "Undoubtedly there has been no flaws in your expenditures.<br> However, by saving too much money you miss on things like medical care or your favourite hobby By keeping your life balanced you will get all of the advantages of saving and not the disadvantages of saving money.<br>Be smart with money! <br>";
                        }
                        if($total_left/$total*100>=50 and $total_left/$total*100<75){
                            echo "Undoubtedly there has been no flaws in your expenditures.<br> However, by saving too much money you miss on things like medical care or your favourite hobby By keeping your life balanced you will get all of the advantages of saving and not the disadvantages of saving money.<br>Be smart with money! <br>";
                        }
                        if($total_left/$total*100>=25 and $total_left/$total*100<50){
                            echo "You have done fairly well in managing your expenditure <br> Your strategy has been fairly effective.<br> However, a more systematic approach could place you into consistancy in the upcoming months. <br>Be smart with money! <br>";
                        }
                        if($total_left/$total*100>=0 and $total_left/$total*100<25){
                            echo "You have done fairly well in managing your expenditure <br> However you need to be more cautious on your expenditure due to the high chance of falling into a negative percentage.<br> Be smart with money! <br>";
                        }
                        if($total_left/$total*100>=-25 and $total_left/$total*100<0){
                            echo "You could optimize your expenditure and save some more money.<br>A simple preplanned expenditure would ease your process.<br> Optimized resources utilization could help you save a lot of money.<br> Be smart with money! <br> You have the potential to obtain a positive percentage." ;
                        }
                        if($total_left/$total*100>=-50 and $total_left/$total*100<-25){
                            echo "You could optimize your expenditure and save some more money.<br>Find a better strategy with the insights given below based on your expected expenditure and actual expenditure.<br>A simple preplanned expenditure would ease your process.<br> Optimized resources utilization could help you save a lot of money.<br> Be smart with money! " ;
                        }
